...
map = {
    ...
    "v1.5": "Input and Output Architectural",
    "v1.6": "Cryptographic Architectural",
    "v1.7": "Errors, Logging and Auditing Architectural",
    ...
    "v1.13": "API Architectural",
    "v1.14": "Configuration Architectural",
    ...
    "v2.9": "Cryptographic Software and Devices Verifier",
    ...
    "v13.1": "Generic Web Service Security Verification",
